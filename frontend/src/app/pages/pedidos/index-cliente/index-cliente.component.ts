...
import { IndexClienteModalComponent } from "./index-cliente-modal.component";
// import { DetalleEnvioModalComponent } from "./detalle-envio-modal.component";

@Component({
  selector: "ngx-index-cliente",
...
export class IndexClienteComponent implements OnInit {
    ...
    this.service_aux.findByIdPerfil().subscribe(
      (data) => {
        this.service_clint.getCliente(data.cod_usuario).subscribe((data2) => {
          this.service.getPedidosCliente(data2[0].codCliente).subscribe(
            (items) => {
  ...
  editarRegistro(value) {
    this.modalRef = this.modalService.open(IndexClienteModalComponent, {
