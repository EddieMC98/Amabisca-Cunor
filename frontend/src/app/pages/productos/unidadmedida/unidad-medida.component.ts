...
export class UnidadMedidaComponent implements OnInit {
  ...
  nuevoRegistro() {
    this.modalRef = this.modalService.open(UnidadMedidaModalComponent, {
      size: "lg",
      container: "nb-layout",
    });
  ...
  editarRegistro(value) {
    ...
    this.service.getUnidad(value.data.codUnidadMedida).subscribe(
      (data) => {
  ...
  eliminarRegistro(value) {
    ...
    this.router.navigate([
      "pages/seguridad/permisos",
      value.data.codUnidadMedida,
    ]);
  }
