...
export class PersonasComponent {
  ...
  constructor(private service: PersonaService, private modalService: NgbModal, private toasterService: ToasterService) {  }
  ...
  nuevoRegistro() {
    this.modalRef = this.modalService.open(PersonasModalComponent, { size: 'lg', container: 'nb-layout' });
  ...
  editarRegistro(value) {
    ...
    this.service.findById(value.data.cod_persona)
        .subscribe(
        data => {
  ...
  eliminarRegistro(value) {
    this.modalRef = this.modalService.open(PersonasDialogComponent, { size: 'lg', container: 'nb-layout' });
    ...
    this.modalRef.result.then((data) => {
      this.service.eliminarPorId(value.data.cod_persona)
          .subscribe(
          data => {
            if (data){
              this.showToast("info", "Personas", "Registro eliminado exitosamente.");
              this.getAll();        
            }else{
